    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const CircleAvatar(
              backgroundImage: AssetImage('assets/Tiger.jpeg'),
            ),
            Text(
              'NAME: ',
              style: TextStyle(
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Padding, Margin, Container'),
    );
  }
}
